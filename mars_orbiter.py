...
class Planet(pg.sprite.Sprite):
    ...
    def gravity(self, satellite):
        ...
        dist_x /= distance
        dist_y /= distance
        # apply gravity (dx and dy represent pixels/frame)
...
def instruct_label(screen, text, color, x, y):
    """Take screen, list of strings, color, and origin and render text to screen."""
...
def main():
    """set up labels and instructions, create objects and run the game loop."""
    pg.init()
    # set up display:
    ...
    instruct_text1 = [
        'Orbital altitute must be within 69-120 miles',
        'Orbital Eccentricity must be <0.05',
        'Avoid top of atmophere at 68 miles'
    ]
    instruct_text2 = [
    ...
    while running:
        ...
        box_label(screen, 'Altitute', (240, 20, 160, 20))
        ...
        box_label(screen, '{:.1f}'.format(sat.fuel), (410, 50, 160, 20))
